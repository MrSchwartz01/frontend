    ...
    <div class="container">
      <div class="footer-content">
        <div class="footer-section">
          <h3>CHpc TECNOLOGÍA</h3>
          <p>Tu tienda de confianza para tecnología gaming y componentes de PC.</p>
      ...
      <div class="footer-bottom">
        <p>&copy; 2025 CHpc TECNOLOGÍA. Todos los derechos reservados.</p>
      </div>
    </div>
  </footer>
</template>
